		...
		<Box className={s.internshipsCardWrapper}>
			...
			<Box className={s.internshipsCardContent}>
				...
				<Flex justify={"space-between"} gap={"0.5rem"} mt={'0.5rem'}>
					<OutlineButton fullWidth h={'2.75rem'} className={s.buttonOutline}>Accept</OutlineButton>
					<OutlineButton fullWidth h={'2.75rem'} className={s.buttonOutline}>Reject</OutlineButton>
				</Flex>
			</Box>
		</Box>
	)
